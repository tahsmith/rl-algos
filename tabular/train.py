...
def train(env, episode_fn, stopping_fn, logging_fn, steps_per_log, *args):
    ...
    while not stopping_fn(returns, i, *tracks):
        ...
        args_new = episode_fn(env.reset(), step, i, *[copy(arg) for arg in args])
...
def train_with_plots(fig, env, episode_fn, max_eps, steps_per_log, value_range, *args):
    ...
    returns, tracks = train(env, episode_fn, stop, log, steps_per_log, *args)
